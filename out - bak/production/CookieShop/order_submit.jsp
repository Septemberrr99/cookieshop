	...
	<div class="cart-items">
		<div class="container">
			...
			<form class="form-horizontal" action="${pageContext.request.contextPath}/order_confirm" method="post" id="payform">
				...
				<div class="row">
					<label class="control-label col-md-1" for="delivery-time">请选择送达时间：</label>
					<div class="col-md-6">
						<input class="form-control" name="delivertime" value="" style="height:auto;padding:10px;" type="datetime-local" id="delivery-time" required="required">
					</div>
				</div>

<%--				<label for="delivery-time">选择送达时间：</label>--%>
